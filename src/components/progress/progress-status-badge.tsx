...
const CONFIG: Record<ProjectStatus, { label: string; className: string; dot: string }> = {
    ...
    development: { label: "Development", dot: "bg-sky-400", className: "bg-sky-500/10 text-sky-400 border border-sky-500/20" },
    revision: { label: "Revision", dot: "bg-amber-400", className: "bg-amber-500/10 text-amber-400 border border-amber-500/20" },
    testing: { label: "Testing", dot: "bg-orange-400", className: "bg-orange-500/10 text-orange-400 border border-orange-500/20" },
    completed: { label: "Completed", dot: "bg-emerald-400", className: "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" },
};

export function ProgressStatusBadge({ status, size = "md" }: { status: ProjectStatus; size?: "sm" | "md" | "lg" }) {
