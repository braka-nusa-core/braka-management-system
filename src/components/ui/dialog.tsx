  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "grid gap-4 rounded-xl border border-white/[0.08] bg-[#111827] p-6 shadow-2xl shadow-black/60",
    ...
    >
      ...
      <DialogPrimitive.Close className={cn(
        "absolute right-4 top-4 rounded-lg p-1 text-[#A1A1AA]",
        "transition-all duration-150 hover:bg-[#18181B] hover:text-[#F4F4F5]",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A3E635]/50",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-base font-semibold text-[#F4F4F5]", className)}
    {...props}
  />
));
